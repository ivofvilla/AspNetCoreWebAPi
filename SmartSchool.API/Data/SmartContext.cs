        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    ...
                    new Professor(5, 5, "Alexandre", "Montana"),
                });
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>
                {
                    ...
                    new Curso(3, "Ciencia da computaçao"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555",     new DateTime(2005,05,08)),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288",   new DateTime(2005,05,08)),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899",  new DateTime(2005,05,08)),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659",     new DateTime(2005,05,08)),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", new DateTime(2005,05,08)),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", new DateTime(2005,05,08)),
                    new Aluno(7, 7, "Paulo", "José", "9874512",      new DateTime(2005,05,08))
                });
